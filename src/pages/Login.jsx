      ...
      <header className="mb-6">
        <div className="flex items-center justify-between">
          ...
          <div className="shrink-0 rounded-2xl border border-white/10 bg-white/5 px-3 py-2 text-right backdrop-blur">
            <p className="text-[11px] font-semibold text-neutral-200">Privado</p>
      ...
      <section className="rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur">
        <form onSubmit={onSubmit} className="space-y-4">
          <label className="block">
            <span className="mb-2 block text-sm font-medium text-neutral-200">Usuario</span>
            <input
          ...
          <label className="block">
            <span className="mb-2 block text-sm font-medium text-neutral-200">Contraseña</span>
